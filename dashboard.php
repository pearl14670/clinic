...
try {
    ...
    $query = "SELECT COUNT(*) as total_requests FROM stud_request";
    $result = $conn->query($query);
    $row = $result->fetch_assoc();
    $requestCount = $row['total_requests'];

    $query = "SELECT COUNT(*) as total_inventory FROM medicines";
    $result = $conn->query($query);
    $row = $result->fetch_assoc();
    $medCount = $row['total_inventory'];
} catch (Exception $e) {
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $medCount; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-users fa-2x text-gray-300"></i>
                                        </div>
